var DNNJuliusForm = DNNJuliusForm || {};

DNNJuliusForm.itemViewModel = function (moduleId, resx) {
    var service = {
        path: "DNNJuliusForm",
    ...
    var loadUsers = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            var result = data[i];
            var user = new DNNJuliusForm.user(result.id, result.name);
...
DNNJuliusForm.user = function (id, name) {
    this.id = id;
    this.name = name;
}